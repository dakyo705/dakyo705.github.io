...
{% capture fig_img %}![image](https://github.com/user-attachments/assets/f7e42a75-8893-42e5-ab3a-ce9077c1547b)
{% endcapture %}
<figure>
  {{ fig_img | markdownify | remove: "<p>" | remove: "</p>" }}
  <figcaption>{{ fig_caption | markdownify | remove: "<p>" | remove: "</p>" }}</figcaption>
...
{% capture fig_img %}![image](https://github.com/user-attachments/assets/3c3a843e-a608-43fa-aafc-ff963a6f0594)
{% endcapture %}
<figure>
  {{ fig_img | markdownify | remove: "<p>" | remove: "</p>" }}
  <figcaption>{{ fig_caption | markdownify | remove: "<p>" | remove: "</p>" }}</figcaption>
...
{% capture fig_img %}![image](https://github.com/user-attachments/assets/6487363d-e2dc-4a6d-aac2-bd1233b3fd28)
{% endcapture %}
<figure>
  {{ fig_img | markdownify | remove: "<p>" | remove: "</p>" }}
  <figcaption>{{ fig_caption | markdownify | remove: "<p>" | remove: "</p>" }}</figcaption>
