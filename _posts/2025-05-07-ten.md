...
{% capture fig_img %}![image](https://github.com/user-attachments/assets/d7bb1480-4d04-4cbd-b666-ac42ef7a86b2)
{% endcapture %}
<figure>
  {{ fig_img | markdownify | remove: "<p>" | remove: "</p>" }}
  <figcaption>{{ fig_caption | markdownify | remove: "<p>" | remove: "</p>" }}</figcaption>
...
{% capture fig_img %}![image](https://github.com/user-attachments/assets/8f357902-2ace-44d5-ba71-0a248e8b2d4c)
{% endcapture %}
<figure>
  {{ fig_img | markdownify | remove: "<p>" | remove: "</p>" }}
  <figcaption>{{ fig_caption | markdownify | remove: "<p>" | remove: "</p>" }}</figcaption>
...
{% capture fig_img %}![image](https://github.com/user-attachments/assets/fd6a319c-80bb-4d91-9901-62b3a2e0bca9)
{% endcapture %}
<figure>
  {{ fig_img | markdownify | remove: "<p>" | remove: "</p>" }}
  <figcaption>{{ fig_caption | markdownify | remove: "<p>" | remove: "</p>" }}</figcaption>
...
{% capture fig_img %}![image](https://github.com/user-attachments/assets/9b74ac5e-6bd6-4f9a-99f0-bf069e7d4f4b)
{% endcapture %}
<figure>
  {{ fig_img | markdownify | remove: "<p>" | remove: "</p>" }}
  <figcaption>{{ fig_caption | markdownify | remove: "<p>" | remove: "</p>" }}</figcaption>
